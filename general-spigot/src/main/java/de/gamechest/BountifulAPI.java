...
/**
 * Created by ByteList on 23.10.2016.
 */
public class BountifulAPI {

    private static final String nmsver = "v1_9_R2";
    ...
    public static void sendActionBar(final Player player, final String message, int duration) {
        ...
        if (duration >= 0) {
            ...
            }.runTaskLater(GameChest.getInstance(), duration + 1);
        }
        ...
        while (duration > 60) {
            ...
            }.runTaskLater(GameChest.getInstance(), (long) sched);
        }
    }
