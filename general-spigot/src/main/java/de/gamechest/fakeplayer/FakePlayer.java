...
public class FakePlayer {
    ...
    private FakePlayer(Player player, Location location, String displayname, Runnable runnable) {
        this.player = player;
    ...
    private FakePlayer(Player player, Location location, String displayname, Runnable runnable, String skinValue, String skinSignature) {
        this.player = player;
        this.location = location.clone();
        this.displayname = displayname;
        this.runnable = runnable;
    ...
    public static class FakePlayerBuilder {
        ...
        public FakePlayerBuilder runnable(Runnable runnable) {
            this.runnable = runnable;
            return this;
        }
