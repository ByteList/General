...
public class Reflection {
    ...
    public static void sendAllPacket(Object packet)
        ...
        for (Player p : Bukkit.getOnlinePlayers()) {
            ...
            connection.getClass().getMethod("sendPacket", new Class[]{getClass("{nms}.Packet")}).invoke(connection, packet);
        }
    }

    public static void sendListPacket(List<Player> players, Object packet) {
        try {
