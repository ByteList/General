        ...
        if(args.length == 1) {
            ...
            if(args[0].equalsIgnoreCase("ca") || args[0].equalsIgnoreCase("clickattack")) {
                ...
                if(!database.existsPlayer(uuid)) {
                    sender.sendMessage(gameChest.pr_stats+"§cDu hast noch keine ClickAttack Runde gespielt.");
                    return;
                }
                ...
                sender.sendMessage(gameChest.pr_stats+"§eDeine ClickAttack Statistik:");
                sender.sendMessage("§8\u00BB §7Position im Ranking: §6"+rank);
                sender.sendMessage("§8\u00BB §7Punkte: §6"+points);
                sender.sendMessage("§8\u00BB §7Spiele: §6"+played+"§7 " +
                        "(Gewonnen: §6"+wins+"§7 / Verloren: §6"+loses+"§7)");
            ...
            if(args[0].equalsIgnoreCase("sd") || args[0].equalsIgnoreCase("shulkerdefence")) {
                ...
                if(!database.existsPlayer(uuid)) {
                    sender.sendMessage(gameChest.pr_stats+"§cDu hast noch keine ShulkerDefence Runde gespielt.");
                    return;
                }
                ...
                sender.sendMessage(gameChest.pr_stats+"§eDeine ShulkerDefence Statistik:");
                sender.sendMessage("§8\u00BB §7Position im Ranking: §6"+rank);
                sender.sendMessage("§8\u00BB §7Punkte: §6"+points);
                sender.sendMessage("§8\u00BB §7Spiele: §6"+played+"§7 " +
                        "(Gewonnen: §6"+wins+"§7 / Verloren: §6"+loses+"§7)");
            ...
            if(args[0].equalsIgnoreCase("dr") || args[0].equalsIgnoreCase("deathrun")) {
                ...
                if(!database.existsPlayer(uuid)) {
                    sender.sendMessage(gameChest.pr_stats+"§cDu hast noch keine DeathRun Runde gespielt.");
                    return;
                }
                ...
                sender.sendMessage(gameChest.pr_stats+"§eDeine DeathRun Statistik:");
                sender.sendMessage("§8\u00BB §7Position im Ranking: §6"+rank);
                sender.sendMessage("§8\u00BB §7Punkte: §6"+points);
...
//                    }
//                    if(rank > 0) {
//                        if (!Stats.getClickAttack().existsRank(rank)) {
//                            sender.sendMessage(gameChest.pr_stats + "§cDieser Platz ist nicht vergeben!");
//                            return;
//                        }
//                        uuid = Stats.getClickAttack().getUuidFromRank(rank);
...
//                }
                ...
                DatabaseClickAttack database = databaseManager.getDatabaseClickAttack();
                if(!database.existsPlayer(uuid)) {
                    sender.sendMessage(gameChest.pr_stats+"§c"+name+" hast noch keine ClickAttack Runde gespielt.");
                    return;
                }
                int rank = database.getDatabaseElement(uuid, DatabaseClickAttackObject.RANK).getAsInt();
                int points = database.getDatabaseElement(uuid, DatabaseClickAttackObject.POINTS).getAsInt();
...
//                    }
//                    if(rank > 0) {
//                        if (!Stats.getShulkerDefence().existsRank(rank)) {
//                            sender.sendMessage(gameChest.pr_stats + "§cDieser Platz ist nicht vergeben!");
//                            return;
//                        }
//                        uuid = Stats.getShulkerDefence().getUuidFromRank(rank);
//                        name = gameChest.getSqlHandler().getLastName("UUID", uuid.toString());
//                    } else {
//                        sender.sendMessage(gameChest.pr_stats+"§cRang muss größer als 0 sein!");
//                        return;
...
//                }
                ...
                DatabaseShulkerDefence database = databaseManager.getDatabaseShulkerDefence();
                if(!database.existsPlayer(uuid)) {
                    sender.sendMessage(gameChest.pr_stats+"§c"+name+" hast noch keine ShulkerDefence Runde gespielt.");
                    return;
                }
                int rank = database.getDatabaseElement(uuid, DatabaseShulkerDefenceObject.RANK).getAsInt();
                int points = database.getDatabaseElement(uuid, DatabaseShulkerDefenceObject.POINTS).getAsInt();
...
//                    }
//                    if(rank > 0) {
//                        if (!Stats.getDeathRun().existsRank(rank)) {
//                            sender.sendMessage(gameChest.pr_stats + "§cDieser Platz ist nicht vergeben!");
//                            return;
//                        }
//                        uuid = Stats.getDeathRun().getUuidFromRank(rank);
//                        name = gameChest.getSqlHandler().getLastName("UUID", uuid.toString());
//                    } else {
//                        sender.sendMessage(gameChest.pr_stats+"§cRang muss größer als 0 sein!");
//                        return;
...
//                }
        ...
        if(gameChest.hasRank(uuid, Rank.SUPPORTER))
            sender.sendMessage(gameChest.pr_stats+"§c/stats <ca/sd/jd/dr> (Spieler)");
        else sender.sendMessage(gameChest.pr_stats+"§c/stats <ca/sd/jd/dr>");
    }
}
